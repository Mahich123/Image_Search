        ...
        <div className="hero bg-dark-blue">
            <section className="gallery">
                <div className="red w-full">
                    ...
                    <div className="mb-3">
                        <div className="w-full input-group relative flex items-stretch">
                            <input
                                id="query" 
                                type="text"
