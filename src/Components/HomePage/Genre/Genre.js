...
const Genre = () => {
  ...
  <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2 p-5 sm:p-20">
    ...
    <div className="p-6 rounded-[10px] ">
      <p className="font-epi text-[#748F99] xs:text-[14px] sm:text-[larger] md:text-[1.45rem]">Popular Genres</p>
        ...
        <button className="bg-[#748F99] text-white font-epi text-[small] my-[2.5rem] py-1 px-3 sm:px-7 sm:py-[0.70rem] rounded inline-flex items-center ">
            <span>All Genres</span>
        </button>
    </div>
    <div className="p-6  bg-[#303B4C] rounded-[10px]">
